...
$db=$ora->oracle();
    ...
    $query_ni="
        ...
        where
            ...
            nmm023.fpro_numper in (".$nidesde.") and 
	...
	while($cantidad<16){
        ...
        if($ni=='no')    
            ...
            $cadena_ni .= "23193".$nac.$cedula.$row['NOMBR1'].$espacios1.$row['NOMBR2'].$espacios2.$row['APELL1'].$espacios3.$row['APELL2'].$espacios4."S00000000000000000000000000".$monto_x."1\r\n";
            //echo $row['APELL2'];
            //exit(0);
        }				
    }
