<div id="menu">
    <ul class="menu">
        ...
        <?php if($sf_user->hasCredential('estudios_admin')){?>
        <li><a href="#" class="parent"><span>ADMINISTRACION</span></a>
                <div><ul>
                    <li><a href="<?php echo url_for('admin/index')?>"><span>Gestionar Solicitudes</span></a></li>                    
                    <?php if($sf_user->isSuperAdmin()){ ?>
                    <li><a href="<?php echo url_for('productos/index')?>"><span>Productos</span></a></li>                    
                    <?php }?>
                </ul></div>
            </li>
        <?php }?>
