<div class="titulo_modulo">GESTIONAR SOLICITUDES DE TRANSPORTE-TR</div>

<?php $mas=$pagina+1; $menos=$pagina-1; if($menos<1) $menos=$cantidad_paginas; if($mas>$cantidad_paginas) $mas=1;?>

<form action="<?php echo url_for("gestion/transportetr")?>" method="post" name="form">
<table class="crud_form">
        ...
        <tr>
            ...
            <td>
                <?php
                    ...
                    else if ($s->getEstatus()=='cj') echo image_tag("cerrado.png");
                    else if ($s->getEstatus()=='r') echo image_tag("rechazo.png");
                    else if ($s->getEstatus()=='ap') echo image_tag("aprobado.jpg",array('size' => '20x20'));
                ?>                
            </td>
            <td><a href="<?php echo url_for('gestion/asignartransportetr?ids='.$s->getIdSolicitud())?>"><?php echo image_tag("busca.png",array('size' => '20x20'))?></a></td>   
