        ...
        <?php 
            ...
            if ($solicitud->getEstatus()=='n') echo "<br><h1>SOLICITUD SIN ASIGNAR</h1>";
                ...
                echo "<br><h1>SOLICITUD ASIGNADA: <br>
                      ...
                      VEHÍCULO: (".ucfirst($vehiculo[0]->getModelo()).' ('.$vehiculo[0]->getPlaca()."))</h1> 
            ...
            else if ($solicitud->getEstatus()=='cj'){
                
                echo "<br><h1 style='color:red;width:500px;'>SOLICITUD CERRAR CON JUSTIFICACIÓN: <br>".$solicitud->getJustificacionRechazo()."<h1>";
...
<?php if($solicitud->getEstatus()!='r' && $solicitud->getEstatus()!='c' && $solicitud->getEstatus()!='cj'){?>
    ...
    <form action="<?php echo url_for("gestion/asignartransportetr?ids=".$ids)?>" method="post" name="form">
    ...
    <?php }else if($opcion=='cerrar_justificar'){?>
        <br><br>
        <table class="crud_form" cellpadding="5px" style="width: 450px;">
            <tr><th>Justifique</th><td><textarea name="justificacion"></textarea></td></tr>
            <tr><td colspan="2" style="text-align: center;"><input type="button" value="Cerrar" id="boton" onclick="enviar_formulario('Cierre justificado')"></td></tr>
        </table>
...
<div class="iconos">
<a href="<?php echo url_for('gestion/transportetr')?>"><?php echo image_tag('volver.jpg')?>&nbsp;&nbsp;Volver</a>
</div>
