...
abstract class autoSfGuardPermissionActions extends sfActions
{
  ...
  public function executeBatch(sfWebRequest $request)
  {
    ...
    $validator = new sfValidatorPropelChoice(array('multiple' => true, 'model' => 'sfGuardPermission'));
    try
    {
      // validate ids
  ...
  {
    return in_array($column, BasePeer::getFieldnames('sfGuardPermission', BasePeer::TYPE_FIELDNAME));
  }
}
