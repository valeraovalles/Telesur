...
/**
 * Base class that represents a row from the 'tsur_dependencias' table.
 *
 * 
 *
 ...
 */
abstract class BaseTsurDependencias extends BaseObject  implements Persistent {
	...
	const PEER = 'TsurDependenciasPeer';
	 ...
	 * @return     TsurDependencias The current object (for fluent API support)
	 */
	public function setIdDependencia($v)
	{
		...
		if ($this->id_dependencia !== $v) {
			...
			$this->modifiedColumns[] = TsurDependenciasPeer::ID_DEPENDENCIA;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = TsurDependenciasPeer::DESCRIPCION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->id_dependencia = ($row[$startcol + 0] !== null) ? (int) $row[$startcol + 0] : null;
			...
			return $startcol + 2; // 2 = TsurDependenciasPeer::NUM_COLUMNS - TsurDependenciasPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating TsurDependencias object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TsurDependenciasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseTsurDependencias:delete:pre') as $callable)
			{
			...
			if ($ret) {
				TsurDependenciasPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTsurDependencias:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseTsurDependencias:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseTsurDependencias:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				TsurDependenciasPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = TsurDependenciasPeer::doInsert($this, $con);
					...
					$affectedRows += TsurDependenciasPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TsurDependenciasPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = TsurDependenciasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = TsurDependenciasPeer::getFieldNames($keyType);
		$result = array(
			$keys[0] => $this->getIdDependencia(),
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[0], $arr)) $this->setIdDependencia($arr[$keys[0]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TsurDependenciasPeer::ID_DEPENDENCIA)) $criteria->add(TsurDependenciasPeer::ID_DEPENDENCIA, $this->id_dependencia);
		if ($this->isColumnModified(TsurDependenciasPeer::DESCRIPCION)) $criteria->add(TsurDependenciasPeer::DESCRIPCION, $this->descripcion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TsurDependenciasPeer::ID_DEPENDENCIA, $this->id_dependencia);
	...
	/**
	 * Generic method to set the primary key (id_dependencia column).
	 *
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of TsurDependencias (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     TsurDependencias Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     TsurDependenciasPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new TsurDependenciasPeer();
		}
		return self::$peer;
	}
	 ...
	 * Otherwise if this TsurDependencias has previously been saved, it will retrieve
	 * related SfGuardUserProfiles from storage. If this TsurDependencias is new, it will return
		...
		if ($this->collSfGuardUserProfiles === null) {
			if ($this->isNew()) {
			   $this->collSfGuardUserProfiles = array();
				...
				$criteria->add(SfGuardUserProfilePeer::ID_DEPENDENCIA, $this->id_dependencia);
	 ...
	 * Otherwise if this TsurDependencias is new, it will return
	 * an empty collection; or if this TsurDependencias has previously
	 * been saved, it will retrieve related SfGuardUserProfiles from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in TsurDependencias.
	 */
	 ...
	 * actually need in TsurDependencias.
	 */
	public function getSfGuardUserProfilesJoinTsurCargos($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TsurDependenciasPeer::DATABASE_NAME);
		}
		...
		if ($this->collSfGuardUserProfiles === null) {
			if ($this->isNew()) {
				...
				$this->collSfGuardUserProfiles = SfGuardUserProfilePeer::doSelectJoinTsurCargos($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseTsurDependencias:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseTsurDependencias::%s', $method));
	  }
