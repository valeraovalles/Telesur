...
/**
 * Base class that represents a row from the 'sit_subcategorias' table.
 *
 * 
 *
 ...
 */
abstract class BaseSitSubcategorias extends BaseObject  implements Persistent {
	...
	const PEER = 'SitSubcategoriasPeer';
	 ...
	 * @return     SitSubcategorias The current object (for fluent API support)
	 */
	public function setIdSubcategoria($v)
	{
		...
		if ($this->id_subcategoria !== $v) {
			...
			$this->modifiedColumns[] = SitSubcategoriasPeer::ID_SUBCATEGORIA;
		}
	...
	public function setIdCategoria($v)
	{
		...
		if ($this->id_categoria !== $v) {
			$this->id_categoria = $v;
			$this->modifiedColumns[] = SitSubcategoriasPeer::ID_CATEGORIA;
		}
	...
	public function setDescripcion($v)
	{
		...
		if ($this->descripcion !== $v) {
			$this->descripcion = $v;
			$this->modifiedColumns[] = SitSubcategoriasPeer::DESCRIPCION;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			return $startcol + 3; // 3 = SitSubcategoriasPeer::NUM_COLUMNS - SitSubcategoriasPeer::NUM_LAZY_LOAD_COLUMNS).

		} catch (Exception $e) {
			throw new PropelException("Error populating SitSubcategorias object", $e);
		}
	}
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = SitSubcategoriasPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			...
			foreach (sfMixer::getCallables('BaseSitSubcategorias:delete:pre') as $callable)
			{
			...
			if ($ret) {
				SitSubcategoriasPeer::doDelete($this, $con);
				$this->postDelete($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSitSubcategorias:delete:post') as $callable)
				{
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			// symfony_behaviors behavior
			foreach (sfMixer::getCallables('BaseSitSubcategorias:save:pre') as $callable)
			{
			...
			if ($ret) {
				...
				$this->postSave($con);
				// symfony_behaviors behavior
				foreach (sfMixer::getCallables('BaseSitSubcategorias:save:post') as $callable)
				{
				  call_user_func($callable, $this, $con, $affectedRows);
				}

				SitSubcategoriasPeer::addInstanceToPool($this);
			} else {
				$affectedRows = 0;
			}
			$con->commit();
	...
	protected function doSave(PropelPDO $con)
	{
		...
		if (!$this->alreadyInSave) {
			...
			if ($this->isModified()) {
				if ($this->isNew()) {
					$pk = SitSubcategoriasPeer::doInsert($this, $con);
					...
					$affectedRows += SitSubcategoriasPeer::doUpdate($this, $con);
				}
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = SitSubcategoriasPeer::doValidate($this, $columns)) !== true) {
	...
	{
		$pos = SitSubcategoriasPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
	...
	{
		$keys = SitSubcategoriasPeer::getFieldNames($keyType);
		$result = array(
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(SitSubcategoriasPeer::ID_SUBCATEGORIA)) $criteria->add(SitSubcategoriasPeer::ID_SUBCATEGORIA, $this->id_subcategoria);
		if ($this->isColumnModified(SitSubcategoriasPeer::ID_CATEGORIA)) $criteria->add(SitSubcategoriasPeer::ID_CATEGORIA, $this->id_categoria);
		if ($this->isColumnModified(SitSubcategoriasPeer::DESCRIPCION)) $criteria->add(SitSubcategoriasPeer::DESCRIPCION, $this->descripcion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(SitSubcategoriasPeer::ID_SUBCATEGORIA, $this->id_subcategoria);
	 ...
	 * objects.
	 *
	 * @param      object $copyObj An object of SitSubcategorias (or compatible) type.
	 ...
	 *
	 * @param      boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
	 * @return     SitSubcategorias Clone of current object.
	 * @throws     PropelException
	 */
	 ...
	 *
	 * @return     SitSubcategoriasPeer
	 */
	public function getPeer()
	{
		if (self::$peer === null) {
			self::$peer = new SitSubcategoriasPeer();
		}
		return self::$peer;
	}
	...
	public function getSitCategorias(PropelPDO $con = null)
	{
		if ($this->aSitCategorias === null && ($this->id_categoria !== null)) {
			...
			/* The following can be used additionally to
			   ...
			   $this->aSitCategorias->addSitSubcategoriass($this);
			 */
		}
	 ...
	 * Otherwise if this SitSubcategorias has previously been saved, it will retrieve
	 * related SitTicketss from storage. If this SitSubcategorias is new, it will return
		...
		if ($this->collSitTicketss === null) {
			if ($this->isNew()) {
			   $this->collSitTicketss = array();
				...
				$criteria->add(SitTicketsPeer::ID_SUBCATEGORIA, $this->id_subcategoria);
	 ...
	 * Otherwise if this SitSubcategorias is new, it will return
	 * an empty collection; or if this SitSubcategorias has previously
	 * been saved, it will retrieve related SitTicketss from storage.
	 *
	 * This method is protected by default in order to keep the public
	 * api reasonable.  You can provide public methods for those you
	 * actually need in SitSubcategorias.
	 */
	...
	{
	  if (!$callable = sfMixer::getCallable('BaseSitSubcategorias:'.$method))
	  {
	    throw new sfException(sprintf('Call to undefined method BaseSitSubcategorias::%s', $method));
	  }
